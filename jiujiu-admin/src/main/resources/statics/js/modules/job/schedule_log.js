$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [			
            { label: 'Log ID', name: 'logId', width: 50, key: true },
			{ label: 'Task ID', name: 'jobId', width: 50},
			{ label: 'bean name', name: 'beanName', width: 60 },
			...
			{ label: 'Execution time(Mils)', name: 'times', width: 70 },
			{ label: 'Create time', name: 'createTime', width: 80 }
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
