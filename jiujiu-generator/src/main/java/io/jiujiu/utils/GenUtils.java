...
package io.jiujiu.utils;

import io.jiujiu.entity.ColumnEntity;
import io.jiujiu.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.jiujiu" : mainPath;
